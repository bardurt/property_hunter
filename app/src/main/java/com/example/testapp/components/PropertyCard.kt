...
@Composable
fun PropertyCard(property: Property, onInfoClick: () -> Unit) {
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(
                ...
                val affordability = if (property.priceIncomeRatio > 0.0) {
                    String.format("%.2f", property.priceIncomeRatio)
                } else {
                    "N/A"
                }
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(
                        text = "Cost Level: $affordability",
                        style = MaterialTheme.typography.bodySmall,
                        fontSize = 18.sp
                    )

                    if (affordability != "N/A") {
                        AffordabilityBadge(property.priceIncomeRatio)
                    }
...
fun BidInfo(property: Property) {
    ...
    Column(
        ...
        Text(
            text = "Latest Bid: ${property.latestBid} kr.",
            style = MaterialTheme.typography.bodySmall,
